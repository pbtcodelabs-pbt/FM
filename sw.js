...
// FM2SEPWE01.html) — جب بھی نئی فائل بھیجیں، یہاں بھی وہی نیا نمبر ڈال دیں۔
...
//
// 📌 قاعدہ (ہر نئی چیٹ میں بھی یہی فالو کریں، 2 ستمبر 2026 سے سٹائل تبدیل):
// فارمیٹ FM{تاریخ}{مہینہ کا 3 حروفی انگریزی کوڈ}{دن کوڈ}{سیریل}
// — جیسے: JAN/FEB/MAR/APR/MAY/JUN/JUL/AUG/SEP/OCT/NOV/DEC
// مثال: 2 ستمبر 2026 (بدھ) کی پہلی فائل = FM2SEPWE01
// — اسی دن کے اندر ہر نئی فائل پر سیریل نمبر ایک آگے بڑھائیں (01 → 02 → 03...)،
...
const CACHE_VERSION = 'FM2SEPWE01';
